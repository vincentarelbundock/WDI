...
#' Writes a codebook containing information about a list of series
#'
#' @param indicator A character vector with a list of WDI indicators
#' @param file File in which the codebook will be written
#' @param cache Data list generated by the \code{WDIcache} function. If omitted, \code{WDIsearch} will search a local list of series.  
#' @return A text string with information about a list of WDI indicators/series 
#' @export
#' @note Warning: If you provide a file path, any existing file will be overwritten. 
#' @examples
#' WDIcodebook(indicator='AG.AGR.TRAC.NO')
WDIcodebook <- function(indicator='AG.AGR.TRAC.NO', file=NULL, cache=NULL){
    info = lapply(indicator, function(j) WDIsearch(j, field='indicator', short=FALSE))
    return(out)
}
